        ...
        if (u.equals("Cydeo") && p.equals("WoodenSpoon")){ // if the credentials are valid/correct
            ...
            for (int i = 0; i < 3; i++) {  //i: 0, 1, 2
                ...
                if (i != 2) {
                    ...
                    System.err.println("This is your last chance. Please re-enter your user name and password");
                }
            ...
            if( ! (u.equals("Cydeo") && p.equals("WoodenSpoon"))  ) { //after all three attempts, if the username or password are still incorrect
