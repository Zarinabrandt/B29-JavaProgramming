...
public class Crew_and_passengers {
    public static void main(String[] args) {
        ...
        String result1 = (number == 50 || number == 75 || number == 100) ?
                ...
                (number == 50)? "20 crew, 30 pessangers"
                :(number == 75)? "25 crew, 50 pessangers"
                : "30 crew, 70 pessangers"
        ...
        switch (number) {
            ...
            case 50:
                result2 = "20 crew, 30 pessangers";
                break;
            case 75:
                result2 = "25 crew, 50 pessangers";
                break;
            case 100:
                result2 = "30 crew, 70 pessangers";
                break;
            default:
                result2 = "Invalid";
        }
