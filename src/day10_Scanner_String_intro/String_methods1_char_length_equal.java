...
public class String_methods1_char_length_equal {
    public static void main(String[] args) {
        ...
        char fourthdChar = str.charAt(3);
        char fifthdChar = str.charAt(4);

        //char sixthChar = str.charAt(5);// not exist character


        System.out.println("firstChar "+firstChar);
        System.out.println("secondChar "+secondChar);
        System.out.println("thirdChar "+thirdChar);
        System.out.println("fourthdChar "+fourthdChar);
        System.out.println("fifthdChar "+fifthdChar);

        //System.out.println("sixthChar "+sixthChar);// not exist character
