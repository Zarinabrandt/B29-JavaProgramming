...
public class MapClasses {
    public static void main(String[] args) {
        ...
        Map<String, Integer> hashMap = new HashMap<>(); // random order, accept null key and null values
        ...
        Map<String, Integer> linkedHashMap = new LinkedHashMap<>(); // insertion order, accept null key and null values
        ...
        Map<String, Integer> treeMap = new TreeMap<>(); // sorted order, does NOT accept nul key, but allows null value
        ...
        Map<String, Integer> hashtable = new Hashtable<>(); // random order, does NOT accept null key nor null value, Synchronized
